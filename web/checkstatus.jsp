...
<%
   ...
   // replace with the desired contact value
    ...
    Class.forName("com.mysql.jdbc.Driver");
       Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","Harshdeep14");
         ...
         PreparedStatement st = con.prepareStatement( "SELECT * FROM book_slot WHERE contact IN (SELECT contact FROM publicbookslot)  ");
  ...
  while(rs1.next())
  {
    ...
    list8.add(rs1.getString(8));
    list9.add(rs1.getString(9));
    list10.add(rs1.getString(10));
    }
