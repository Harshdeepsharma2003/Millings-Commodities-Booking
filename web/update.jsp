...
<%
    ...
    String address1 = request.getParameter("address");
     if(name1.equals("")||contact1.equals("")||address1.equals("")){
    RESULT=1;
    }
    else{
    ...
    if(rs.next()){
    PreparedStatement st1 = con.prepareStatement("update customer_account_mc set name=?,address=?,password=? where contact=?");
    st1.setString(1, name1);
    st1.setString(2, address1);
     st1.setString(3,contact1);
    st1.executeUpdate();
