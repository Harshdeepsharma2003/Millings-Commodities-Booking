...
if (button != null && button.equalsIgnoreCase("Update")) {
    ...
    if (contact1 == null || contact1.equals("") || newPass.equals("") || confirmPass.equals("")) {
        RESULT = 1;
    } else {
        if (!newPass.equals(confirmPass)) {
            RESULT = 3; // passwords do not match
        } else {
            ...
            if (rs.next()) {
                PreparedStatement st1 = con.prepareStatement("update shopkeeper_account_mc set password=? where contact=?");
                st1.setString(1, newPass);
                st1.setString(2, contact1);
                st1.executeUpdate();
                response.sendRedirect("shopkeeper_signin.jsp");
            } else {
                RESULT = 2; // contact not found
            }
            con.close();
        }
    }
...
<body>
  ...
  <div class="container">
     ...
     <div class="form-group">
        ...
        <button class ="btn"  name="btn" value="Update">UPDATE
        </button>
