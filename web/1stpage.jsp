...
<%
    ...
    if (button != null && button.equalsIgnoreCase("sign up")) {
        ...
        if (name1.equals("") || contact1.equals("") || address1.equals("") || password1.equals("")) {
            RESULT = 1;
        } else {
            ...
            PreparedStatement st = con.prepareStatement("insert into customer_account_mc values(?,?,?,?)");
       ...
       // Create a session and set the contact attribute
                    ...
                    session1.setAttribute("name",name1);
                    session1.setAttribute("contact", contact1);
session1.setAttribute("address", address1);*/

            response.sendRedirect("1stpagepublicsigninpage.jsp");
        }
    }
%>
...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            <div class="left">
                ...
                <div>Fresh flour,every hour!
                    ...
                    <br>
                    <br>
                    <a href="1stpagepublicsigninpage.jsp">SIGN IN?</a>
            ...
            <div class="mid">
                <ul class="navbar">
                    ...
                    <li><a href="http://wa.me/9301887856">Contact us</a></li>
            ...
            <div class="right">
                <a href="shopkeeper.jsp"><img src="Images/usertype_profile.png" alt="SHOPKEEPER"style="width:100px;height:100px;">
                    <br>SHOPKEEPER</a></div>
        ...
        <script>
            function check() {
                if (user_signup.name.value == 0 || user_signup.contact.value == 0 || user_signup.address.value == 0 || user_signup.password.value == 0 {
    ...
    <div class="form-group">
                ...
                <div class="form-group">
                    <textarea placeholder="Enter your current address" name="address" style="width:230px;height:50px"></textarea>
                </div>
                ...
                <%
                    if (RESULT == 1) {
                %>
                <p style="color: white;">Please fill all the fields!</p>
                <%
                    }
                %>

                <button class="btn" name="btn" value="Sign Up" onClick="check()">Submit</button>
